 ...
 */
public class Button2 extends AppCompatButton implements LangChangableView {
    ...
    public Button2(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        init(paramContext, paramAttributeSet);
    }

    public Button2(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
